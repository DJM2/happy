                    ...
                    <nav class="site-navigation text-right" role="navigation">
                        <div class="container">
                            ...
                            <ul class="site-menu main-menu js-clone-nav d-none d-lg-block">
                                ...
                                <li class="has-children">
                                    <a href="../../es/tours-alternativos" class="nav-link" @if (request()->is('en/alternative tours')) id="active" @endif>Alternativos</a>
                                    <ul class="dropdown arrow-top">
                                        <li><a href="../../es/tour-7-lagunas-ausangate" class="nav-link">7 Lagunas</a></li>
                                        <li><a href="../../es/huchuy-qosqo-a-machu-picchu" class="nav-link">Huchuy Qosqo</a></li>
