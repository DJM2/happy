                        ...
                        <ul class="site-menu main-menu js-clone-nav d-none d-lg-block">
                            <li class="has-children">
                                ...
                                <ul class="dropdown arrow-top">
                                    ...
                                    <li><a href="happy-city-tour-full-day" class="nav-link">Happy city tour Full Day</a>
                                    </li>
                                    <li><a href="valle-sagrado-2-dias" class="nav-link">Valle Sagrado & Machu Picchu</a>
                                    </li>
                                    <li><a href="valle-sagrado-full-day" class="nav-link">Valle Sagrado de los incas</a>
                                    </li>
                                    <li><a href="maras-moray-salineras-tour" class="nav-link">Maras/Moray &
                                            Salineras</a></li>
                                </ul>
                            </li>
                            <li class="has-children">
                                <a href="aventuras" class="nav-link"
                                    @if (request()->is('es/aventuras')) id="active" @endif>Aventura</a>
                                <ul class="dropdown arrow-top">
                                    <li><a href="choquequirao-tour-4-dias" class="nav-link">Choquequirao 4 días</a></li>
                                    <li><a href="huchuy-qosqo-a-machu-picchu" class="nav-link">Huchuy Qosqo & Machu
                                            Picchu 2 días</a></li>
                                    ...
                                    <li><a href="valle-sagrado-3-dias" class="nav-link">Valle Sagrado & Camino Inca 3
                                            días</a>
                                    </li>
                            ...
                            <li class="has-children">
                                <a href="tours-alternativos" class="nav-link"
                                    @if (request()->is('es/tours-alternativos')) id="active" @endif>Alternativos</a>
                                <ul class="dropdown arrow-top">
                                    ...
                                    <li><a href="waqrapukara-full-day-tour" class="nav-link">Waqra Pucara full day</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="has-children">
                                <a href="tours-en-tren" class="nav-link"
                                    @if (request()->is('tours by train')) id="active" @endif>tours en tren</a>
                                <ul class="dropdown arrow-top">
                                    <li><a href="inca-trail-360°-tren-tour" class="nav-link">Inca Rail 360° tour en
                                            tren</a></li>
                                    <li><a href="inca-rail-primera-clase" class="nav-link">Inca Rail first class tour
                                            en tren</a>
                                    </li>
                                    <li><a href="inca-rail-voyager-tren" class="nav-link">Inca Rail Voyager tour en
                                            tren</a></li>
                                    <li><a href="peru-rail-tren-expedition" class="nav-link">Peru Rail expedition tour
                                            en tren</a>
                                    </li>
                                    <li><a href="hiram-binghan-tour-en-tren" class="nav-link">Peru Rail Hiram Bingham
                                            tour en tren</a></li>
                                    <li><a href="perurail-valle-sagrado-tour" class="nav-link">Peru Rail Valle Sagrado
                                            tour en tren</a></li>
                                    <li><a href="tren-perurail-vistadome" class="nav-link">Peru Rail vistadome tour en
                                            tren</a>
                                    </li>
                                </ul>
                            </li>
                            <li @if (request()->is('blog')) class="active" @endif><a
                                    href="../blog-peru-castellano" class="nav-link">Blog</a></li>
