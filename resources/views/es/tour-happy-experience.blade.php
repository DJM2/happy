...
<body>
    ...
    <li><a href="../en/happy-experience-tour" class="nav-link" id="idioma-responsive">English</a>
    </li>
    </ul>
    </div>
    </nav>
                    ...
                    <div class="row photos">
                        <div class="col-sm-6 col-md-4 col-lg-4 item">
                            <a href="{{ asset('img/galeria/happy-cusco-exclusive.jpg') }}" data-lightbox="photos">
                                <img class="img-fluid"
                                    src="{{ asset('img/thumbnail/happy-cusco-exclusive.jpg') }}"
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4 item">
                            <a href="{{ asset('img/galeria/happy-cusco-experience.jpg') }}" data-lightbox="photos">
                                <img class="img-fluid"
                                    src="{{ asset('img/thumbnail/happy-cusco-experience.jpg') }}"
                                    alt="city tour cusco">
                            </a>
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-4 item">
