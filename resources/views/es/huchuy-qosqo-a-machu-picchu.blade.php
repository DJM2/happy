...
<head>
    ...
    <title>Huchuy Qosqo, tour de 2 días | Travel Agency Perú</title>
        ...
        <li class="has-children">
            ...
            <ul class="dropdown arrow-top" style="width: 120px">
                <li><button class="btn-lang"
                        onclick="window.location.href='{{ route('huchuy-qosqo-to-machu-picchu') }}'">English</button>
                </li>
                <li><button class="btn-lang"
                        onclick="window.location.href='{{ route('huchuy-qosqo-2-dias-portugues') }}'">Portugués</button>
                </li>
            </ul>
        </li>
    </div>
    ...
    <div class="container form">
        <div class="abs-center form-index">
            <h1 class="text-center h1-tours">
                <?php $titulo = 'Huchuy Qosqo & Machu Picchu';
                echo $titulo; ?>
            </h1>
            <p class="p-titulo">
                <i class="icon-map-marker"></i> Cusco - Valle Sagrado - Machupicchu&nbsp;&nbsp;
                <i class="icon-dollar"></i> <?php $precio = 580;
                echo $precio; ?>.00
            </p>
