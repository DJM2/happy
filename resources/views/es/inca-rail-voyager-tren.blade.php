...
<head>
    ...
    <title>Inca Rail Voyager tour en tren, tren a Machu Picchu | Travel Agency</title>
    <meta name="description"
        content="Te ofrecemos un maravilloso viaje a Machu Picchu, rodeado de un hermoso paisaje andino que podrás disfrutar gracias a la más amplia y alta panorámica.">
    <meta name="keywords"
        content="Primera clase, inca rail primera clase, Inca trail, inca trek, inca trail, tren inca, tren voyager, tren a machu picchu, tren exclusivo, inca rail tren, inca rail, inka rail tour">
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Inca Rail Voyager tour en tren, tren a Machu Picchu | Travel Agency" />
    <meta property="og:image" content="https://happyperutours.com/img/panoramic/inca-rail-tour-train.webp" />
    <link rel="canonical" href="https://happyperutours.com/es/inca-rail-voyager-tren">
</head>
...
<body>
    ...
    <li>
        <a href="../en/inca-rail-voyager-train">
            <idioma>English</idioma>
        </a>
    </li>
    <li><a href="../en/inca-rail-voyager-train" class="nav-link" id="idioma-responsive">English</a>
    </li>
    </ul>
    </div>
    </nav>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 display">
                    ...
                    <div class="similares">
                        ...
                        <a href="hiram-binghan-tour-en-tren">
                            <p>Exclusivo Tour Tren Hiram Bingham</p>
                        </a>
                ...
                <div class="col-lg-6">
                    ...
                    <p class="p-tours">
                        Iniciaremos la travesía disfrutando de un excelente servicio y cómodos asientos. Disfrute del
                        increíble paisaje andino que podrá encontrar camino a Machu Picchu, entre imponentes montañas,
                        picos nevados, río serpenteante. El cambio de vegetación lo sorprenderá al entrar en el mágico
                        bosque húmedo que alberga la ciudadela Inca de Machu Picchu. Goce de una variedad de bebidas
                        naturales de cortesía, preparadas con esencias andinas que representan a la región. La
                        amabilidad de nuestro personal le garantizará una agradable experiencia hasta llegar a la
                        estación de trenes de Aguas Calientes.
                        .
                    </p><br>
                    <h5 class="h5-tours"> Itinerario:</h5>
                    <p class="p-tours">
                        <fuerte>El viaje en tren: </fuerte> <br>
                        Pasaremos por su hotel 02 horas y media antes de la salida del tren, para recogerlos y nos
                        dirigiremos hacia la estación de trenes de Ollantaytambo, desde donde partiremos en tren para
                        conocer una de las Siete maravillas modernas del mundo. Arribaremos a la estación de trenes
                    ...
                    <fuerte>La visita a Machupicchu: </fuerte> <br>
                    <p class="p-tours">
                        ...
                        de retorno. A su arribo a la estación de Ollantaytambo será trasladado a su hotel en la ciudad
                        del Cusco.
                    </p>
                        ...
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="card-body">
                                    ...
                                    &check; Pasajes en tren ida y vuelta Ollantaytambo - Machu Picchu - Ollantaytambo.<br>
                        ...
                        <div class="card">
                            ...
                            <div id="collapseFour" class="collapse" aria-labelledby="headingThree"
                                ...
                                <div class="card-body">
                                    ...
                                    &#10034; Una vez aceptada la reserva el pasajero debe enviar por e-mail la copia de su pasaporte o cedula de identidad en forma obligatoria.<br>
