    ...
    <div class="site-navbar-wrap">
        ...
        <li class="has-children">
            ...
            <ul class="dropdown arrow-top" style="width: 120px">
                ...
                <li><button class="btn-lang"
                        onclick="window.location.href='{{ route('vale-sagrado-e-trilha-inca') }}'">Portugués</button>
                </li>
            </ul>
        </li>
    </div>
    ...
    <div class="container form">
        <div class="abs-center form-index">
            <h1 class="text-center h1-tours">
                <?php $titulo = 'Valle Sagrado & Camino Inca';
                echo $titulo; ?>
            </h1>
            <p class="p-titulo">
                <i class="icon-map-marker"></i> Cusco - Valle Sagrado - Machupicchu &nbsp;&nbsp;
                <i class="icon-dollar"></i> <?php $precio = 570;
                echo $precio; ?>.00
            </p>
