...
<body>
    ...
    <li class="has-children">
        ...
        <ul class="dropdown arrow-top" style="width: 120px">
            <li><button class="btn-lang" onclick="window.location.href='{{route('adventure')}}'">English</button></li>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card card-index">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Disfruta del increible camino Inca en dos días para llegar a Machu Picchu.
                            </p>
                            <div class="line-card">
