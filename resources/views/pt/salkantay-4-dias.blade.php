...
<head>
    ...
    <title>Tour a Salkantay por 4 días | Travel Agency Perú</title>
    <meta name="description"
        content="Si no dispones de muchos días en el Cusco, pero quieres realizar el trek del Salcantay ésta es una buena opción para disfrutar de la maravilla de esta ruta...">
    <meta name="keywords"
        content="Cusco, Tour Salkantay, salkantay trek, tour a salkantay, salkantay trek 4 dias, 4 dias caminata a salkantay, salkantay exclusive tour, caminata a salkantay, salkantay a machu picchu">
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Tour a Salkantay por 4 días | Travel Agency Perú" />
    <meta property="og:image" content="https://happyperutours.com/img/thumbnail/salkantay-adventure.jpg" />
    <link rel="canonical" href="https://happyperutours.com/es/tour-salkantay-4-dias">
</head>
...
<body>
    ...
    <li class="has-children">
        ...
        <ul class="dropdown arrow-top" style="width: 120px">
            ...
            <li><button class="btn-lang"
                    onclick="window.location.href='{{ route('salkantay-4-dias-español') }}'">Español</button>
            </li>
        </ul>
    </div>
    </nav>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <table class="table text-center">
                        ...
                        <tbody>
                            <tr>
                                <td>Moderado</td>
                                <td>6 horas</td>
                                <td>$470.00 por adulto</td>
                            </tr>
                        </tbody>
                    </table>
                    <h5 class="h5-tours">Vista General:</h5>
                    <p class="p-tours">
                        Si no dispones de muchos días en la ciudad del Cusco, pero quieres realizar el trek del
                        Salcantay ésta es una buena opción para disfrutar de la maravilla de esta ruta. Considerado una
                        de las mejores caminatas del mundo, es la forma más increíble de llegar a MACHUPICCHU; esta ruta
                        de senderismo atraviesa uno de los nevados más importantes de la ciudad del Cusco que es el
                        SALKANTAY (6270 m.s.n.m.), la caminata esconde magníficos paisajes naturales y nos invita a
                        descubrir las maravillas de las regiones del Perú. Iniciando en la región Quechua 3000 m.s.n.m.
                        luego acampar sobre los 3900 m.s.n.m. región Puna, hasta llegar al paso del SALKANTAY 4650
                        m.s.n.m. y finalmente conocer nuestra ceja de selva o selva alta 1900 m.s.n.m. durante su
                        trayecto se aprecia la gran variedad de flora y fauna silvestre. Un día antes de llegar a
                        nuestro objetivo que es MACHU PICCHU podremos ascender a una de las últimas construcciones incas
                        LLACTAPATA desde donde divisamos la gran ciudadela de MACHUPICCHU con una vista impresionante
                        del valle.
                    </p><br>
                    ...
                    <p class="p-tours">
                        ...
                        caminata y tener tiempo para algunas actividades como hacer el tour del café, el trayecto en
                        este día será gradual con algunas pequeñas subidas y caminos planos por aproximadamente 5 horas
                        luego arribaremos al poblado llamado LA PLAYA, llegando al medio día, posterior a un riquísimo
                        almuerzo abordaremos el bus que nos llevará hasta la estación de tren de HIDROELÉCTRICA, durante
                        el trayecto en bus podremos apreciar el cambio de clima teniendo a la vista variedad de fruta
                        típica de la zona, una vez en la estación se tendrá dos opciones para continuar el tour, uno es
                        tomando el tren hacia aguas calientes( pago opcional de 34 dólares) o si todavía hay fuerzas y
                        energía hacer una caminata de 3 horas más hasta llegar al pueblo de aguas calientes donde nos
                        espera una noche confortable y una cena de despedida en un restaurante del lugar.
                    </p>
                    <p class="p-tours text-center">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                ...
                                <div class="card-body">
                                    ...
                                    &#10008; Bolsa de dormir<br>
                                    &#10008; Costo de actividades extras<br>
                                    &#10008; Propinas
                                </div>
                            </div>
                        </div>
