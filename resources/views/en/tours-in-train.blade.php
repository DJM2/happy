                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card card-index">
                        ...
                        <div class="card-body">
                            ...
                            <a href="inca-trail-360°-train-tour" class="boton-happy-2">More Info</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="card card-index" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="inca-rail-first-class" class="boton-happy-2">More Info</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="card card-index" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="inca-rail-voyager-train" class="boton-happy-2">More Info</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="card card-index" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="peru-rail-expedition-train" class="boton-happy-2">More Info</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="card card-index" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="perurail-vistadome-train" class="boton-happy-2">More Info</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="card card-index" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="hiram-binghan-train-tour" class="boton-happy-2">More Info</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="card card-index" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="perurail-sacred-valley-tour" class="boton-happy-2">More Info</a>
                        </div>
                    </div>
                </div>
            </div>
